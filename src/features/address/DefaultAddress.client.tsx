...
const DefaultAddressFragment = gql(`
  fragment DefaultAddress on MailingAddress {
    id
    formatted
    firstName
    lastName
...
interface Props {
  address?: DocumentType<typeof DefaultAddressFragment>;
}

export const DefaultAddress: FC<Props> = (props) => (
  <div>
    <Responsive
      desktop={DesktopDefaultAddress}
      mobile={MobileDefaultAddress}
      props={props}
    />
    <div className="mb-10">
      <AccountMenu selected="myAddress" />
    </div>
  </div>
);

const DesktopDefaultAddress: FC<Props> = ({ address }) => (
  <div className="flex flex-col">
    ...
    <div className="bg-attention pt-10 pb-14 mb-12 flex justify-center">
      <div className="flex justify-center">
        <div className="flex flex-col">
          <div className="mb-2">
            <SubHeading title="MYADDRESS" subTitle="登録住所編集" />
          </div>
...
const MobileDefaultAddress: FC<Props> = ({ address }) => (
  <>
